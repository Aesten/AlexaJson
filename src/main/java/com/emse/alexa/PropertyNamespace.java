...
public enum PropertyNamespace {
    ALEXA_AUTOMATION_MANAGEMENT, ALEXA_BRIGHTNESS_CONTROLLER, ALEXA_CHANNEL_CONTROLLER, ALEXA_COLOR_CONTROLLER, ALEXA_COLOR_TEMPERATURE_CONTROLLER, ALEXA_CONTACT_SENSOR, ALEXA_COOKING, ALEXA_COOKING_PRESET_CONTROLLER, ALEXA_COOKING_TIME_CONTROLLER, ALEXA_ENDPOINT_HEALTH, ALEXA_EQUALIZER_CONTROLLER, ALEXA_EVENT_DETECTION_SENSOR, ALEXA_INPUT_CONTROLLER, ALEXA_INVENTORY_LEVEL_SENSOR, ALEXA_LAUNCHER, ALEXA_LOCK_CONTROLLER, ALEXA_MODE_CONTROLLER, ALEXA_MOTION_SENSOR, ALEXA_NETWORKING_ACCESS_CONTROLLER, ALEXA_PERCENTAGE_CONTROLLER, ALEXA_POWER_CONTROLLER, ALEXA_POWER_LEVEL_CONTROLLER, ALEXA_RANGE_CONTROLLER, ALEXA_RECORD_CONTROLLER, ALEXA_SECURITY_PANEL_CONTROLLER, ALEXA_SPEAKER, ALEXA_TEMPERATURE_SENSOR, ALEXA_THERMOSTAT_CONTROLLER, ALEXA_TIME_HOLD_CONTROLLER, ALEXA_TOGGLE_CONTROLLER;
    ...
    @JsonCreator
    public static PropertyNamespace forValue(String value) throws IOException {
        ...
        throw new IOException("Cannot deserialize PropertyNamespace");
    }
}